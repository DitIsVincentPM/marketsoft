...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="https://cdn.discordapp.com/attachments/692058346626351205/734503900198994111/IMG-1.png"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item active">
                                        <img class="d-block w-100"
                                            src="https://cdn.discordapp.com/attachments/692058346626351205/734503901193044028/img-2.png"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="https://cdn.discordapp.com/attachments/692058346626351205/734503904670122095/IMG-4.png"
                                            alt="Third slide">
                                    </div>
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 5">
        <div id="liveToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="bg-success toast-header">
                <strong class="me-auto">ShoppingCart</strong>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div class="bg-success toast-body">
                <span id="product_added_name"></span>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
