...
<div class="header-home-height header-section background-gradient-primary">
  <div class="row">
    ...
    <div class="col-3 center-content-home mt-20 col-max-mobile">
      <h1 class="color-white rotate-text-header"><?php echo e($companyname); ?>,</h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('assets.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/softwarelol/resources/views/index/home.blade.php ENDPATH**/ ?>