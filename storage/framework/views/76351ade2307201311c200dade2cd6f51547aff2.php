...
<a style="<?php if($check[2] != true): ?> display: none; <?php endif; ?> cursor: pointer;" id="tab-button" data-name="modules" class="list-group-item list-group-item-action">
...
<a style="<?php if($check[3] != true): ?> display: none; <?php endif; ?> cursor: pointer;" id="tab-button" data-name="addons" class="list-group-item list-group-item-action">
...
<a style="<?php if($check[4] != true): ?> display: none; <?php endif; ?> cursor: pointer;" id="tab-button" data-name="themes" class="list-group-item list-group-item-action">
...
</a><?php /**PATH /var/www/softwarelol/resources/views/Admin/Vendor/Settings/sidebar.blade.php ENDPATH**/ ?>