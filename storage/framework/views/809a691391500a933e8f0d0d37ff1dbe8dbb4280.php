        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-1" style="width: 5%;">
                    <a style="position: absolute;top: 50%;transform: translateY(-50%);" class="pull-right market-text-primary" href="<?php echo e(route('knowledgebase.article.view', $knowledgebase->id)); ?>" title="Read More"><i class="pull-right" data-feather="eye"></i></a>
                </div>
            </div>
        </div>
    </div>
