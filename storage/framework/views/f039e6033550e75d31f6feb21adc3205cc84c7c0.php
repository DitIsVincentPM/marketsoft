...
<div class="primary-section">
    <div class="row justify-content-center">
        <div class="col-10">
            <form method="POST" action="<?php echo e(route('ticket.new.create')); ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Vendor.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/softwarelol/resources/views/Modules/TicketSystem/new.blade.php ENDPATH**/ ?>