...
<button style="width: 200px; border: 0; background: linear-gradient(149deg, #0683ff 0%, #0d44ff 100%) !important; box-shadow: -1px 0px 22px -10px rgba(0,0,0,0.2);" class="btn btn-sm btn-primary">VIEW PRODUCTS</button>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div>
    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 pull-right mobile-remove" style="margin-top: 6%;">
        <img src="/icons/frontpage.svg" class="img-fluid" alt="...">
    </div>
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 pull-right mobile-text-center" style="margin-top: 6%;">
        ...
        <a href="#" style="color: #1f8bfd; font-size: 15px; text-decoration: none;" class="text-uppercase">FIND OUT MORE</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>
