...
<?php $__env->startSection('content'); ?>
                        ...
                        <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row mb-2 mt-4">
                                ...
                                <div class="col-2 text-center">
                                    <form method="POST"
                                        action="<?php echo e(route('admin.knowledgebase.category.delete', $category->id)); ?>">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body pb-0">
                        <?php $__currentLoopData = $knowledgebases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $knowledgebase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row  mb-2 mt-4">
                                ...
                                <div class="col-2 text-center">
                                    <form method="POST"
                                        action="<?php echo e(route('admin.knowledgebase.delete', $knowledgebase->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn btn-sm pull-right text-danger" title="Delete">
                                            <i data-feather="trash"></i>
                                        </button>
                                    ...
                                    <button class="btn btn-sm pull-right text-success" data-bs-toggle="modal"
                                        data-bs-target="#editknowledgebase-<?php echo e($knowledgebase->id); ?>">
                                        <i data-feather="edit-3"></i>
                                    </button>
                                </div>
                            </div>
    ...
    <?php $__currentLoopData = $knowledgebases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $knowledgebase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="editknowledgebase-<?php echo e($knowledgebase->id); ?>" tabindex="-1"
                        ...
                        <form method="POST" action="<?php echo e(route('admin.knowledgebase.update', $knowledgebase->id)); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description"
                                    class="summernote"><?php echo e($knowledgebase->description); ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Articles Category</label>
                                <select class="form-select" name="category">
