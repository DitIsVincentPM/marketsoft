...
<div class="row">
    <?php for($i=0; $i < count($modules["modules"]); $i++): ?>
        <div class="col-6">
            <form action="<?php echo e(route('admin.modules.upload', 1)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card mb-3">
                    <div class="card-header">
                        <p class="mb-0 mt-1 pull-left"><?php echo e($modules["modules"][$i]["name"]); ?></p>
                        <button class="pull-right md-0 mt-0 btn-sm btn btn-success">Install</button>
                    </div>
                    <div class="card-body">
                        <?php echo e(Shorten::string($modules["modules"][$i]["description"], 60)); ?>
