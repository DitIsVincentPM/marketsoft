...
<footer class="footer-bg text-center text-lg-start">
  ...
  <div class="footer-bg text-center p-3">
    ...
    <a class="text-dark" href="<?php echo e(route('index.home')); ?>"><?php echo e($companyname); ?></a>
  </div>
</footer>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('assets.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/softwarelol/resources/views/information/knowledgebase/view.blade.php ENDPATH**/ ?>