            ...
            <div class="row product-gallery mx-1">
                <div class="col-12 mb-0">
                    <figure class="view overlay rounded z-depth-1 main-img">
                        <a data-fancybox="galleryTwo"><img src="{{ $product->logo }}" alt="gallery-item" class="gallery-h-img popular-gallery"></a>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="view overlay rounded z-depth-1 gallery-item">
                                <a class="gallery-square-img-wrapper" data-fancybox="galleryTwo"><img src="{{ $product->logo }}" width="150" alt="gallery-item" class="gallery-h-img popular-gallery"></a>
