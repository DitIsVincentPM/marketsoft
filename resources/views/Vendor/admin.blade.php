            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    <ul class="navbar-nav navbar-mobile">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.settings') }}#general" class="nav-link">Settings</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a id="menu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Others</a>
                            <ul aria-labelledby="menu" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('admin.announcements') }}" class="dropdown-item">Announcements</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.knowledgebase') }}#article" class="dropdown-item">Knowledgebase</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.tickets') }}#ticket" class="dropdown-item">Tickets</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
